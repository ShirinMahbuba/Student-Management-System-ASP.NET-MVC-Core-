...
namespace webapp04.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(webapp04Context context)
        {
            _context = context;
        }
        ...
        {
            var webapp04Context = _context.Course.Include(c => c.Department);
            return View(await webapp04Context.ToListAsync());
        }
